...
export const REQUEST_GET_ENTITIES = 'REQUEST_GET_ENTITIES';
export const SUCCESS_GET_ENTITIES = 'SUCCESS_GET_ENTITIES';
export const ERROR_GET_ENTITIES = 'ERROR_GET_ENTITIES';
